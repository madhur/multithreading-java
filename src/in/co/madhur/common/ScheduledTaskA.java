...
public class ScheduledTaskA extends TimerTask {
    ...
    public void run() {
        ...
        System.out.println("###[" + currentThreadName + "] <" + taskId + "> SCHEDULED TO RUN AT : " + dateFormatter.format(scheduledForRunningTime) + ", ACTUALLY STARTED AT: " + dateFormatter.format(startTime) + " ####");
